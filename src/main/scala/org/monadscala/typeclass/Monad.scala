...
object Monad {
  private final class MonadForNotation[F[_]: Monad, A](ma: F[A]) extends ForNotation[F, F, F, A] {
  ...
  def forNotation[F[_]: Monad, A](ma: F[A]): ForNotation[F, F, F, A] = new MonadForNotation(ma)
